...
class hadithFav extends StatefulWidget {
  @override
  State<hadithFav> createState() => _hadithFavState();
}

class _hadithFavState extends State<hadithFav> {
  @override
          ...
          Expanded(
            ...
            child: Stack(
              children: [
                ...
                FutureBuilder(
                  future: myDatabase.getHadithFav(),
